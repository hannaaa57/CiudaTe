    ...
    <div class="bd-content bg-light container-lg border-top ">
      <div class="container-md text-black mt-4">
        ...
        <div class="justify-content-center text-center mb-3">
          <img :src="" alt="Foto de perfil" width="200" height="" class="d-block mx-auto rounded-circle">
        </div>
        <!--Nombre-->
        <div class="row ">
          <label for="nombre2" class="col-sm-3 col-form-label">Nombre</label>
          <div class="col-sm-9">
            <input type="text"  :value="" class="form-control" id="name" name="name" disabled>
          </div>
        </div>
        <!--Correo-->
        ...
        <div class="row mb-3 my-3">
          ...
          <div class="col-sm-9">
            <input type="tel" value="" class="form-control" id="telefono" name="telefono" disabled>
          </div>
        </div>
        <!--Fecha nac-->
        <div class="row mb-3 my-3">
          ...
          <div class="col-sm-9">
            <input type="date" value="" class="form-control" id="fecNacimiento" name="fecNacimiento" disabled>
          </div>
        </div>
        <!--Genero-->
        <div class="row mb-3 my-3">
          ...
          <div class="col-sm-9">
            <input type="text" value="" class="form-control" id="genero" name="genero" disabled>
          </div>
        </div>
      </div>
    </div>
